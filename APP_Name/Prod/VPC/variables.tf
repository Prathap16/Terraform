...
variable "availability_zone" {
  description = "availability zone used for the Dev servers, based on region"
  default = {
...
variable "vpc_name" {
  description = "VPC for building Prod servers"
}
...
variable "vpc_cidr_block" {
  description = "Uber IP addressing for Prod server Network"
}
